        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 items-center">
          ...
          >
            ...
            <p className="text-white/80 md:text-xl max-w-xl">
              Discover our summer collection and enjoy exclusive discounts on selected items. Don&apos;t miss out on these amazing deals!
            </p>
          ...
          >
            <div className="relative">
              <Image
                ...
                priority
              />
              <div className="absolute top-4 right-4 bg-white text-primary rounded-full px-4 py-2 font-bold text-lg shadow-lg">
                50% OFF
              </div>
            </div>
          </motion.div>
